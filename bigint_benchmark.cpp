...
int main()
{
    ...
    Bigint<256> TWO_N("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFD755DB9CD5E9140777FA4BD19A06C8282");
    Bigint<256> EIGHTY_EIGHT("FFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD03641410000000000000000000000");
    std::cout << TWO_N << " == " << (N << 1) << std::endl;
    if (N << 1 == TWO_N)
        std::cout << "<< wordks pog" << std::endl;
    std::cout << EIGHTY_EIGHT << " == " << (N << 88) << std::endl;
